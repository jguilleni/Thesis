...
function [I,SNR,PSNR,q]=diffusion_DICOM(A,vert,Temp,Niter)
...
% Relative variance
R(j,i)=var(I(vert(1):vert(2),vert(3):vert(4)))/var(A(vert(1):vert(2),vert(3):vert(4)));
% Metrics
[snr(j,i),psnr(j,i),Q(j,i)] = Metrics(A,I,vert);
    end
I(:,:,i)=I;
       end
   r=(mean(R,2))';
